          ...
          <div className="row justify-content-center">
            <div className="col-lg-3 col-md-6 col-sm-6 ">
              ...
              <div className="mb-2">
                ...
                <div className="footer-head">
                  SWİFT KODU:<span className="footer-color">GENODEM1SPO </span>
                </div>
                <div className="footer-head">
                  HESAP SAHİBİ:
                  <span className="footer-color">
            ...
            <div className="col-lg-2 gx-1 col-md-6 col-sm-6">
              <h5 className="mt-2 footer-head">GENEL BAKIŞ</h5>
              <Link href="/menu/flat-pack">
                <div className="mt-3 cursor footer-color">Demonte</div>
              </Link>
              <Link href="/menu/wohncontainer">
                <div className="mt-3 cursor footer-color">Yaşam Konteyneri</div>
              </Link>
              <Link href="/menu/burocontainer">
                <div className="mt-3 cursor footer-color">Ofis Konteyneri</div>
              </Link>
              ...
              <Link href="/menu/sanitarcontainer">
                <div className="mt-3 cursor footer-color">Kabin</div>
              </Link>
              <Link href="/menu/pfortnercontainer">
                <div className="mt-3 cursor footer-color">Güvenlik Kabini</div>
              </Link>
              ...
              <Link href="/menu/cafe-container">
                <div className="mt-3  cursor footer-color">Kafe Konteyneri</div>
              </Link>
              <Link href="/menu/schulcontainer">
                <div className="mt-3 cursor footer-color">Okul Konteyneri</div>
              </Link>
            </div>
            <div className="col-lg-2 col-md-6  col-sm-6 ">
              {" "}
              <h5 className="mt-2 footer-head">BİZE ULAŞIN</h5>
            ...
            <div className="col-lg-3 gx-5 col-md-6 col-sm-6 ">
              ...
              <div className="mt-3 cursor footer-color">KÜTÜPHANE</div>
              <Link href="/uber-uns">
                <div className="mt-3 cursor footer-color">HAKKIMIZDA</div>
              </Link>
              ...
              <Link href="https://www.containhaus.de/assets/img/KATALOG.pdf">
                <div className="mt-3 cursor footer-color">KATALOG</div>
              </Link>
            </div>

            <p className="mt-5 text-center text-light">
              © 2022, Developed by World Seven Prefabrik
            </p>
          </div>
        </div>
      </footer>
